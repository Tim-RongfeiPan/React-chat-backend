...
import { Get } from '@user/controller/get.profile';
import { Search } from '@user/controller/search.user';
import { Update } from '@user/controller/change.password';
import { Edit } from '@user/controller/update.info';
import { UpdateSettings } from '@user/controller/update.setting';
